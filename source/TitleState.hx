	...
	override function beatHit()
	{
		...
		if(!closedState) {
			...
			switch (sickBeats)
			{
				...
				case 9:
					addMoreText('PixelAves is here too');
	
				case 11:
					deleteCoolText();
					var randoTexto = FlxG.random.getObject([['Turn it off'], ["Not over yet"], ["ah eh eh oo ah oh", "eh eh oo eh ah oh"], ["He's dead", "I'm cold", "We're not the same"],
					  ["I can never go back"], ["Get me out of here", "Get me out of here"], ["White", "Then Black"], ["I can still hear its song"],
					  ["Should've brought a", "scarf or something"], ["I don't even have red hair", "Stop calling me Silver"], ["Boo"],
					  ["Take this blanket", "It'll cure your", "third degree frostbite"], ["I want to", "  ", "I want to commit arson"]]);
				...
				case 14:
					addMoreText('Hypnos Lullaby');
				// credTextShit.text += '\nNight';
				case 15:
					addMoreText('But its just Blake'); // credTextShit.text += '\nFunkin';
