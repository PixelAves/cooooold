...
class ChartingState extends MusicBeatState
{
	...
	[
		...
		['Fakesong', 'its literally almost impossible to beat destiny monochrome with the third celebi. im not even joking it insta-kills you most of the time no matter what your health is. anyways youre welcome.'],
		['Destiny Bond', 'its too late. either way, its a lose-lose situation.'],
		['Bond', 'this is just the audio cue lol'],
